Com esta pesquisa, queremos que seja avaliada a qualidade das capacitações oferecidas no âmbito do Programa de Descentralização da Execução de Serviços em parceria com o Terceiro Setor. 
As informações coletadas serão utilizadas exclusivamente para aprimorar nossos conteúdos! 
